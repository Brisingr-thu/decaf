...
public abstract class Tree {
    ...
    public static final int CHOOSE = PRINT + 1;
    public static final int BF = CHOOSE + 1;
    public static final int DEFAULT = BF + 1;
	...
	public static class Ternary extends Expr {
		...
		public Expr second;
		public Expr third;
	    public Ternary(int kind, Expr first, Expr second, Expr third, Location loc) {
	        super(kind, loc);
			this.first = first;
			this.second = second;
			this.third = third;
	...
	public static class Switch extends Tree {
		...
		public Switch(Expr expr, List<Tree> cases, Location loc) {
			super(SWITCH, loc);
			this.expr = expr;
			this.cases = cases;
		}
    ...
    public static class Case extends Tree {	
    	public Expr con;
    	public List<Tree> blocks;
    	
    	public Case(Expr con, List<Tree> blocks, Location loc) {
    		super(CASE, loc);
    		this.con = con;
    		this.blocks = blocks;
    	}
    ...
    public static class Default extends Tree {
    	...
    	public Default(List<Tree> blocks, Location loc) {
    		super(DEFAULT, loc);
    		this.blocks = blocks;
    	}
